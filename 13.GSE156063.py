...
# try:
#     newVenn(house,X,Y,title='1.GSE156063.'+'new')
# except:
#     print('mmax<2')
...
# try:
#     newVenn(house,X,Y,title='1.GSE156063.'+'old')
# except:
#     print('mmax<2')
...
# try:
#     Venn4(house,X,Y,zhibiao,title='1.GSE156063.'+'ancestor')
# except:
#     print('mmax<2')
...
try:
    Venn4(house,X,Y,zhibiao,title='13.GSE156063.'+'threshold')
except:
    print('mmax<2')
