...
# try:
#     newVenn(house,X,Y,title='1.GSE161731_xpr.'+'new')
# except:
#     print('mmax<2')
...
# try:
#     newVenn(house,X,Y,title='1.GSE161731_xpr.'+'old')
# except:
#     print('mmax<2')
...
# try:
#     Venn4(house,X,Y,zhibiao,title='1.GSE161731_xpr.'+'ancestor')
# except:
#     print('mmax<2')
...
try:
    Venn4(house,X,Y,zhibiao,title='13.GSE161731_xpr.'+'threshold')
except:
    print('mmax<2')
