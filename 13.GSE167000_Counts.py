...
# 把输出重定向到文件
f = open('13.GSE167000_Counts.log', 'w')
...
# try:
#     newVenn(house,X,Y,title='1.GSE167000_Counts.'+'new')
# except:
#     print('mmax<2')
...
# try:
#     newVenn(house,X,Y,title='1.GSE167000_Counts.'+'old')
# except:
#     print('mmax<2')
...
# try:
#     Venn4(house,X,Y,zhibiao,title='1.GSE167000_Counts.'+'ancestor')
# except:
#     print('mmax<2')
...
try:
    Venn4(house,X,Y,zhibiao,title='13.GSE167000_Counts.'+'threshold')
except:
    print('mmax<2')
