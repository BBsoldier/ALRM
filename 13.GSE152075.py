...
# try:
#     newVenn(house,X,Y,title='1.GSE152075.'+'new')
# except:
#     print('mmax<2')
...
# try:
#     newVenn(house,X,Y,title='1.GSE152075.'+'old')
# except:
#     print('mmax<2')
...
# try:
#     Venn4(house,X,Y,zhibiao,title='1.GSE152075.'+'ancestor')
# except:
#     print('mmax<2')
...
try:
    Venn4(house,X,Y,zhibiao,title='13.GSE152075.'+'threshold')
except:
    print('mmax<2')
