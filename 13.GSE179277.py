...
# try:
#     newVenn(house,X,Y,title='1.GSE179277.'+'new')
# except:
#     print('mmax<2')
...
# try:
#     newVenn(house,X,Y,title='1.GSE179277.'+'old')
# except:
#     print('mmax<2')
...
# try:
#     Venn4(house,X,Y,zhibiao,title='1.GSE179277.'+'ancestor')
# except:
#     print('mmax<2')
...
try:
    Venn4(house,X,Y,zhibiao,title='13.GSE179277.'+'threshold')
except:
    print('mmax<2')
